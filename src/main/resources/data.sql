...
INSERT INTO roadbookride.article (id, titre, tags, description, texte, id_auteur, nb_vues, date_publication) VALUES (1, 'La moto pour les nulles', 'nulle', 'On vous explique la moto', 'alors une moto n''est pas un scooter !!!!c''est beaucoup mieux', 2, 2, '2020-01-21');
INSERT INTO roadbookride.article (id, titre, tags, description, texte, id_auteur, nb_vues, date_publication) VALUES (2, 'Bien choisir son équipement', 'equipement', 'Les équipement moto', 'Pour bien choisir son équipement il faut bien connaitre son corps et surtout la taille qu''il vous faut !!', 1, 5, '2020-01-08');

INSERT INTO roadbookride.service (id, nom, categorie, description, nbr_place, note, id_region, id_utilisateur) VALUES (1, 'au dodo', 'hotel', 'une chambre chez l''habitant', 5, 2, 1, 2);
INSERT INTO roadbookride.service (id, nom, categorie, description, nbr_place, note, id_region, id_utilisateur) VALUES (2, 'jojo la bricol', 'mecanique', 'je répare vos moto a domicile', 1, 5, 3, 3);
...
INSERT INTO roadbookride.evenement (id, nom, type, description, id_region, date, id_organisateur, id_roadbook) VALUES (1, 'Les vieilles moto', 'Concentration', 'RDV le 12/12/12 a Montreuil', 3, '1970-01-08', 2, null);
INSERT INTO roadbookride.evenement (id, nom, type, description, id_region, date, id_organisateur, id_roadbook) VALUES (2, 'Enchère sur Paris', 'Vente', 'RDV a la salle des ventes', 1, '2023-01-19', 1, null);

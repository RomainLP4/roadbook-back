...
INSERT INTO roadbookride.utilisateur (id, pseudo, email, password, nom, prenom, telephone, niveau, ville, role) VALUES (2, 'RobTheBear', 'robert@gmail.com', 'Robear', 'Roussely', 'Robert', '0606056006', 'Expert', 'Drap', 'Moderateur');
INSERT INTO roadbookride.utilisateur (id, pseudo, email, password, nom, prenom, telephone, niveau, ville, role) VALUES (3, 'Sof', 'sophie.balcon@gmail.com', 'fzr', 'Balcon', 'Sophie', '0620458598', 'Confirmé', 'Pontchâteau', 'User');
...
INSERT INTO roadbookride.roadbook (id, nom, id_region, description, kilometrage, difficulte, id_utilisateur,likes) VALUES (2, 'La route du vin', 1, 'On va boire un coup', 200, 'facile', 2, 5);
...
INSERT INTO roadbookride.evenement (id, nom, type, description, id_region, date, id_utilisateur, id_roadbook, image_url, lieu) VALUES (1, 'Les vieilles motos', 'Concentration', 'RDV le 12/12/12 a Montreuil', 3, '1970-01-08', 2, null,'https://lesvieilleschoses.com/119982-large_default/moto-peugeot-p56-vintage.jpg', 'Montreuil');
INSERT INTO roadbookride.evenement (id, nom, type, description, id_region, date, id_utilisateur, id_roadbook, image_url, lieu) VALUES (2, 'Enchères sur Paris', 'Vente', 'RDV a la salle des ventes', 1, '2023-01-19', 1, null, 'https://image1.lechorepublicain.fr/photoSRC/WlJTJ1xYUTgIDAVOKzc8Ik5iH3UMBQgfa15JWhcaSA4rFEgrEEgiLAlEShZNFxIUEkQE/ventes-aux-encheres-de-64-motos-et-7-cycles-de-1910-a-1975-a_4473379.jpeg', 'Paris');

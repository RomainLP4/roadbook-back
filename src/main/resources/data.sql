...
INSERT INTO roadbookride.service (id, nom, categorie, description, image_url, nbr_place, note, id_region, utilisateurs_id) VALUES (1, 'au dodo', 'hotel', 'une chambre chez l''habitant', 'http://www.slate.fr/sites/default/files/styles/1060x523/public/maison-hobbit.jpg', 5, 2, 1, 1);
INSERT INTO roadbookride.service (id, nom, categorie, description, image_url, nbr_place, note, id_region, utilisateurs_id) VALUES (2, 'jojo la bricol', 'mecanique', 'je répare vos moto a domicile','https://moto-station.com/wp-content/uploads/2009/06/10-1.jpg', 1, 5, 3, 2);
